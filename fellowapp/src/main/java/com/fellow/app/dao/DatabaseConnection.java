...
public class DatabaseConnection {
    ...
    public static Connection getConnection() throws SQLException {
        if (connection == null || connection.isClosed()) {
            ...
            // EKLENEN KISIM: SQLite Foreign Key (Yabancı Anahtar) desteğini zorla açıyoruz
    ...
    private static void seedDummyData(Connection conn) {
        try {
            ...
            if (rs.getInt(1) == 0) {
                stmt.execute(
                        "INSERT INTO events (title, type, course_id, event_date, event_time, description, user_id, created_date) VALUES ('C++ Algoritmalar Finali', 'EXAM', 1, '2026-06-15', '14:00', 'Çalış', 1, '2026-03-25 10:00:00')");
                stmt.execute(
                        "INSERT INTO events (title, type, course_id, event_date, event_time, description, user_id, created_date) VALUES ('Veri Yapıları Ağaç Projesi', 'PROJECT', 1, '2026-04-10', '23:59', 'Teslim tarihi', 1, '2026-03-28 10:00:00')");
                stmt.execute(
                        "INSERT INTO events (title, type, course_id, event_date, event_time, description, user_id, created_date) VALUES ('Matematik Ödevi', 'HOMEWORK', 1, '2026-04-05', '09:00', 'Sayfa 50', 1, '2026-03-27 10:00:00')");
            }
            rs.close();
